...
6. **Polish and release** — Give the library a deliberate, calm, and pleasant visual design; add colors, notes, and tags only if they remain necessary; test in Chrome; complete the `PUBLISHING.md` checklist.
